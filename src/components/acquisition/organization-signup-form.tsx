...
export function OrganizationSignupForm() {
  ...
  return (
    <form action={formAction} className="space-y-7">
      ...
      <section className="border-t border-slate-200 pt-7">
        ...
        <div className="mt-4 grid gap-4 md:grid-cols-2">
          ...
          <label className="block">
            ...
            <select name="employeeCountRange" required className="w-full rounded-xl border border-slate-300 bg-white px-4 py-3 outline-none focus:border-indigo-500 focus:ring-4 focus:ring-indigo-100">
      ...
      <section className="border-t border-slate-200 pt-7">
        <p className="text-xs font-black uppercase tracking-[0.18em] text-indigo-600">
          3. {fr ? "Démonstration" : "Demo request"}
        </p>
