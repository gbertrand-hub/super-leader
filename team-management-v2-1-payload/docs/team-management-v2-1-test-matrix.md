...
- Verifier que les formulaires de modification et d'affectation sont absents.
- Ouvrir `Membres & affectations`.
- Verifier que seuls les collaborateurs des equipes dirigees apparaissent.

Resultat attendu : aucune autre equipe ni aucun autre collaborateur de l'organisation n'est visible.
