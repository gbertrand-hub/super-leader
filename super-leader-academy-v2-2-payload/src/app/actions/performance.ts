...
export async function calculateMonthlyPerformanceAction(formData: FormData) {
  ...
  const [settingsResult, membersResult, schedulesResult, detailedSchedulesResult, attendanceResult, leavesResult, reportsResult, meetingsResult, meetingAttendanceResult, feedbackResult, recognitionsResult, academyCoursesResult, academyEnrollmentsResult, kpiResult] = await Promise.all([
  ...
  const anyError = [settingsResult.error, membersResult.error, schedulesResult.error, detailedScheduleError, attendanceResult.error, leavesResult.error, reportsResult.error, meetingsResult.error, meetingAttendanceResult.error, feedbackResult.error, recognitionsResult.error, academyCoursesResult.error, academyEnrollmentsResult.error, kpiResult.error].find(Boolean);
