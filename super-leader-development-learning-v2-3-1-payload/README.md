...
## Mise à jour - Plan de croissance V2.3.1
...
La migration 028 relie Super Leader Academy au Plan de croissance, ajoute les parcours iLEAD, les heures de formation, les heures de lecture et les crédits de développement.

Documentation :

- `docs/growth-impact-v2-3.md`
- `docs/growth-impact-v2-3-test-matrix.md`
- `docs/development-learning-hours-v2-3-1.md`
- `docs/development-learning-hours-v2-3-1-test-matrix.md`
