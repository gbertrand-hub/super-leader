          ...
          <article className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div className="mt-5 grid gap-3 sm:grid-cols-2">
              ...
              <form action={clockOutAction}>
                <ConfirmSubmitButton confirmation={t("myDay.quickActions.clockOutConfirmation")} disabled={!attendance?.clock_in_at || Boolean(attendance.clock_out_at)} className="w-full rounded-xl border border-indigo-300 bg-indigo-50 px-5 py-3 font-black text-indigo-800 transition hover:bg-indigo-100 disabled:cursor-not-allowed disabled:opacity-40">
