                ...
                <article className="rounded-3xl border border-amber-200 bg-amber-50 p-6 shadow-sm">
                  ...
                  {supervisedAttendanceRows.length ? (
                    <form action={reopenWorkdayAction} className="mt-5 space-y-4">
                      ...
                      <ConfirmSubmitButton confirmation={t("performance.reopenWorkdayConfirmation")} className="w-full rounded-xl bg-amber-500 px-5 py-3 font-black text-slate-950">{t("performance.reopenWorkdayButton")}</ConfirmSubmitButton>
                    </form>
              ...
              <article className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                {availableReportDates.length ? (
                  <form action={submitDailyReportAction} className="mt-5 space-y-4">
                    ...
                    <ConfirmSubmitButton confirmation={editableReport ? t("performance.reportRevisionConfirmation") : t("performance.reportSubmitConfirmation")} className="w-full rounded-xl bg-indigo-700 px-5 py-3 font-black text-white">{editableReport ? t("performance.submitRevision") : t("performance.submitReport")}</ConfirmSubmitButton>
                  </form>
                ) : currentReport ? (
