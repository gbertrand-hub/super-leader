  ...
  return (
    <main className="min-h-screen bg-slate-50 text-slate-950">
      ...
      <section className="bg-slate-950 px-5 pb-28 pt-16 text-center text-white">
        <p className="text-xs font-black uppercase tracking-[.22em] text-amber-400">SUPER LEADER V2.5.1</p>
      ...
      <section className="mx-auto -mt-12 max-w-7xl px-5 pb-24">
            ...
            return (
              ...
              >
                ...
                <div className="mt-auto pt-8">
                  ...
                  >
                    {fr ? `Demander une démo ${plan.name}` : `Request a ${plan.name} demo`}
                  </Link>
                </div>
              </article>
            );
        ...
        {usingFallback ? (
          <p className="mx-auto mt-6 max-w-3xl text-center text-sm text-slate-500">
            {fr
              ? "Le catalogue public utilise temporairement les offres provisoires intégrées. Exécutez la migration V2.5.1 pour publier ces plans dans l’administration."
              : "The public catalogue is temporarily using built-in provisional offers. Run the V2.5.1 migration to publish these plans in administration."}
          </p>
        ) : null}
